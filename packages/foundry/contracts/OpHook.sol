...
interface IOptionPrice {
	function getPrice(
		uint collateralPrice, uint256 strike, uint256 expiration, bool isPut, bool inverse
...
contract OpHook is BaseHook, Ownable, ReentrancyGuard, Pausable {
    ...
    constructor(address _poolManager, address permit2)
    ...
    function setOptionPrice(address optionPrice_) onlyOwner public {
