...
contract OptionPriceTest is Test {
    ...
    function testBlackScholesATMPut() public view {
        ...
        uint256 putPrice = op.blackScholesPrice(underlying, strike, timeToExpiration, volatility, riskFreeRate, isPut);
    ...
    function testBlackScholesDebug() public view {
        ...
        uint256 callPrice = op.blackScholesPrice(underlying, strike, timeToExpiration, volatility, riskFreeRate, isCall);
