...
import { useTradableOptions, type TradableOption } from "../../trade/hooks/useTradableOptions";
import { formatUnits } from "viem";
import { useRfqPricingStream, type RfqPriceData } from "../hooks/useRfqPricingStream";
...
function RfqPriceCell({ option, label, onSelect, getPrice }: RfqPriceCellProps) {
  ...
  const priceDisplay = priceData
    ? `${priceData.bid.toFixed(2)}/${priceData.ask.toFixed(2)}`
    : "—";
